...
@implementation qsx_chatModelView
...
- (void)createView
{
    ...
    _tableView = [[UITableView alloc]initWithFrame:CGRectMake(0, 0, ScreenWidth, ScreenHight-64-44) style:UITableViewStylePlain];
...
- (void)emojiClicked:(NSString *)strEmoji {
    UITextView *tv = [self viewWithTag:101];
